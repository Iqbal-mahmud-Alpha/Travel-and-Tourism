...
public class ViewBookedHotel extends JFrame {
    ...
    public ViewBookedHotel(String username) {
        ...
        lblCountry.setBounds(35, 270, 250, 25);
        ...
        la2.setBounds(35, 430, 200, 25);
        contentPane.add(la2);

        JLabel l10 = new JLabel();
        l10.setFont(new Font("Yu Mincho", Font.PLAIN, 20));
        l10.setBounds(271, 430, 200, 25);
        contentPane.add(l10);
        ...
        btnExit.setBounds(160, 500, 140, 40);
        btnExit.setFont(new Font("Yu Mincho", Font.PLAIN, 20));
