...
public class ViewHotel extends JFrame implements Runnable{
    ...
    public ViewHotel() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/and/tourism/icon/hotel1.jpg"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("travel/and/tourism/icon/hotel2.jpg"));
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("travel/and/tourism/icon/hotel3.jpg"));
        ...
        ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("travel/and/tourism/icon/hotel4.jpg"));
        ...
        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("travel/and/tourism/icon/hotel5.jpg"));
        ...
        ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("travel/and/tourism/icon/hotel6.jpg"));
        ...
        ImageIcon i19 = new ImageIcon(ClassLoader.getSystemResource("travel/and/tourism/icon/hotel7.jpg"));
        ...
        ImageIcon i22 = new ImageIcon(ClassLoader.getSystemResource("travel/and/tourism/icon/hotel8.jpg"));
        ...
        ImageIcon i25 = new ImageIcon(ClassLoader.getSystemResource("travel/and/tourism/icon/hotel9.jpg"));
        ...
        ImageIcon i28 = new ImageIcon(ClassLoader.getSystemResource("travel/and/tourism/icon/hotel10.jpg"));
